...
\begin{itemize}
    ...
    \item прогресс к целевой стороне;
    \item признаки эндшпиля.
\end{itemize}
\end{block}
\end{frame}
...
\small
Для каждого алгоритма предусмотрены три уровня сложности. Уровень определяет допустимую глубину поиска, ограничение времени на выбор хода и число рассматриваемых продолжений.
\end{block}
\end{frame}
